...
<body>
    <div>
        ...
        <div class="menu-lateral">
            ...
            <a class="btn btn-primary btn-block btn-simples" id="logar" href="editarAjusteTrabalhador.html">Editar </a>
            <a class="btn btn-primary btn-block btn-simples" id="logar"
                href="visualizarAjusteTrabalhador.html">Visualizar </a>
        </div>
        <div class="contexto p-4">
            ...
            <div class="box-topo p-1">
                    ...
                    <div class="tab-content">
                        ...
                        <div>
                            <table style="width:100%">
                                ...
                                <tr>
                                    <th>
                                        <input id="data" placeholder="DD/MM/AAAA" type="text" value=""
                                            class="form-control" oninput="formatar(this, 'data');" onfocusout="validaData(this);">
                                    <th>
                                    <th>
                                        <input id="horaEntrada" placeholder="HH:MM" type="text" value=""
                                            class="form-control" oninput="formatar(this, 'hora');" onfocusout="validaHoraMinuto(this);">
                                    <th>
                                    <th>
                                        <input id="horaSaida" placeholder="HH:MM" type="text" value=""
                                            class="form-control" oninput="formatar(this, 'hora');" onfocusout="validaHoraMinuto(this);">
                                    <th>
                                    <th>
                ...
                <div style="float: right">
                    <a href="#" class="btn btn-primary  btn-simples" id="btnInserir" onclick="validaPreenchimento();">Inserir hora</a>
                        ...
                        <div>
                            <table style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <th>
                                            <input id="TotalHoras" placeholder="" type="text" value=""
